                      ...
                      Row(
                        ...
                        children: [
                          ElevatedButton(
                              ...
                              child: _radioGroupA == 0 ? const Text("Open USB printer") : const Text("Open serial printer")
                          ) ,
                          ...
                          ElevatedButton(
                              ...
                              child: _radioGroupA == 0 ? const Text("Close USB printer") : const Text("Close serial printer"),
                          ),
                          const SizedBox(width: 20),
                          Visibility(
